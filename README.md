...
|-------------------|--------------|------------|----------------------------|------------------------------------------|-------------------------------------|---------------|--------------------------------------------|
| Внесение данных   | /api/orders  | POST       | Базовая авторизация        | Создание нового заказа с данными из JSON | id: Uuid, обязательный, ИД сущности | JSON с данными| 200 OK: {"message": "Заказ успешно создан"}|
|                   |              |            |                            |                                          |                                     |               | <br> 400 Bad Request: {"message": "Неверные| |                   |              |            |                            |                                          |                                     |               | данные"}     
|                   |              |            |                            |                                          |                                     |               |                                            |
| Оплата            | /api/orders  | POST       | Базовая авторизация        | Проверка данных и проведение оплаты      | id: Uuid, обязательный, ИД сущности |JSON с данными | 200 OK: {"message": "Оплата успешно 
|                   | {id}/payment |            |                            |                                          |                                     |  оплаты       | проведена"} <br> 404 Not Found: {"message":|
|                   |              |            |                            |                                          |                                     |               | "Заказ не найден"}                         ||                  |              |            |                            |                                          |                                     |               |                                            |
|  Удаление заказа  | /api/orders/ | DELETE     | Базовая авторизация        | Удаление заказа по ИД                    | id: Uuid, обязательный, ИД сущности |      -        | 200 OK: {"message": "Заказ успешно удален"}|
|                   | {id}         |            |                            |                                          |                                     |               | <br> 404 Not Found: {"message":"Заказ не   |
|                   |              |            |                            |                                          |                                     |               | не найден"}                                |
|                   |              |            |                            |                                          |                                     |               |                                            |
